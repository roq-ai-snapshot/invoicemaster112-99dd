  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Business with invoiceMaster1121: Streamline B2B Invoicing and Payments, Customize Payment Requests, and Seamlessly Integrate with Your Existing Accounting Infrastructure."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Business with invoiceMaster1121: Streamline B2B Invoicing and Payments, Customize Payment
              Requests, and Seamlessly Integrate with Your Existing Accounting Infrastructure.
            </Text>
            <Text>Manager</Text>
