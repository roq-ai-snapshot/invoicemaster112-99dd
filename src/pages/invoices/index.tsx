...
function InvoiceListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<InvoiceInterface[]>(
    ...
    () =>
      getInvoices({
        relations: ['organisation', 'user', 'dispute.count', 'payment.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('dispute', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>dispute</Th>}
