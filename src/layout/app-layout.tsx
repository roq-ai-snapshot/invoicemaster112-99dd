...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Dispute', path: '/disputes', entity: 'dispute', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
  ...
  { name: 'Report', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiBarChart },
  {
